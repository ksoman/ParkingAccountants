...
namespace ParkingAccountant.ViewModels
{
    ...
    {
        public IDataStore<Member> MemberStore => DependencyService.Get<IDataStore<Member>>() ??new MemberDataStore();
      //  public IDataStore<Item> ItemStore => DependencyService.Get<IDataStore<Item>>() ?? new MockDataStore();
        public IDataStore<Plan> PlanStore => DependencyService.Get<IDataStore<Plan>>() ?? new PlanDataStore();
